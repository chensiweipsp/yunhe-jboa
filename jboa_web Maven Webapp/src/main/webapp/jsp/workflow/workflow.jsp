...
<body>
								...
								<tr>
									<td><table width="100%" border="0" cellspacing="0"
											...
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1">部署信息管理列表</span>
												</td>
											</tr>
										</table>
									</td>
					...
					<c:forEach items="${depList}" var="dep">
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF"><div align="center"
									class="STYLE21">
									<a
										href="workflowAction_delDeployment.action?deploymentId=${dep.id}">删除</a>
								</div></td>
						</tr>
					</c:forEach>
				</table>
								...
								<tr>
									<td><table width="100%" border="0" cellspacing="0"
											...
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1">流程定义信息列表</span>
												</td>
											</tr>
										</table>
									</td>
					...
					<c:forEach items="${pdList}" var="pd">
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF"><div align="center"
									class="STYLE21">
									<a
										href="workflowAction_delDeployment.action?deploymentId=${pd.deploymentId}">删除</a>
								</div></td>
						</tr>
					</c:forEach>
				</table>
	...
	<br />
	<!-- 发布流程 -->
	<form action="<%=basePath%>workflowAction.do?method=newdeploy"
									...
									<tr>
										<td><table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="94%" valign="bottom"><span class="STYLE1">部署流程定义</span>
													</td>
												</tr>
											</table>
										</td>
			...
			<tr>
				<td>
					<div align="left" class="STYLE21">
						...
						流程文件:<input name="files" type="file" cssStyle="width: 200px;" /><br />
